...
<body>
    ...
    if(isset($_POST['submit'])){
        ...
        if($fileerror==0){
            ...
            $insert="INSERT INTO `samsung` (`name`, `camera`, `brand`, `memory_storage`, `complete_name`, `description`, `price`, `image`) VALUES ('$name', '$camera', '$brand', '$memory_storage', '$complete_name', '$description', '$price', '$destinationfile');";
