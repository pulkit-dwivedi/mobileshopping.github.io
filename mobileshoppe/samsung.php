...
<html>
    ...
    <div class="heading" id="samsung_heading">Samsung Phone's</div>
    ...
    <?php
        ...
        // print_r($page);
        $samsungpage--;
        $samsungoffset = ($samsungpage) * $samsunglimitt;
        $samsungsql = "SELECT * FROM `samsung`  LIMIT $samsungoffset ,$samsunglimitt";
        ...
        ?>
            <div class="ele  border-gradient-green ">
                <form action="managecart.php?action=add&id=<?php echo $samsungpd['s_no']; ?>" method="POST">
                    <div class="for_image">
        ...
        <?php
        $samsungpagi = 'select * from `samsung` ';
        $samsungtoexecute = mysqli_query($conn, $samsungpagi);
        if (mysqli_num_rows($samsungtoexecute) > 0) {
            $samsungtopassintotal = mysqli_num_rows($samsungtoexecute);
            $samsunglimitt = 15;
            $samsungtotalpage = ceil($samsungtopassintotal / $samsunglimitt);
            echo '<ul class="ultag">';
            for ($i = 1; $i <= $samsungtotalpage; $i++) {
                echo '<li class="litag"><a href="samsung.php?page='.$i.'">' . $i . '</a></li>';
            }
            echo '</ul>';
        }
