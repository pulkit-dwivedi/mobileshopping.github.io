...
<body>
    <div id="notification">
        <h2 style="color:green;background-color:grey;font-weight:bold;">Login In Successfully</h2>
    ...
    <div class="main">
        ...
        <div class="for_signup">
            <form class="form" method="POST" action="">
                <div class="first">
                    <input class="space" type="email" placeholder=" Email" autocomplete="off" name="email" required>
                </div>
                <div class="second">
                    <input class="space" type="password" placeholder=" Password" name="password">
                </div>
                <div class="third">
                    <input type="submit" value="LOGIN" class="submit" name="login">
                </div>
            </form>
            <span class="spann">New user?<a href="signup.php"> Sign Up</a></span>
        </div>
    </div>
